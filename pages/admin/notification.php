...
function showParentDetails(data) {
    const content = `
        <p><strong>National ID:</strong> ${data.national_id}</p><a type="button" class="btn btn-outline-success  mt-2" href="../uploads/${data.national_id}" download>Download</a>
        <p class="mt-2"><strong>Job Title:</strong> ${data.job_title}</p>
        ...
        <p>
            ...
            <a type="button" class="btn btn-outline-success  mt-2" href="../uploads/${data.income_proof}" download>Download Income Proof</a><br>
            <a type="button" class="btn btn-outline-success  mt-2" href="../uploads/${data.sworn_affidavit}" download>Download Sworn Affidavit</a>
        </p>
    `;
    ...
    btn.addEventListener('click', function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = 'actions/approve_request.php';
                form.submit();
            }
        });
    });
    ...
    btn.addEventListener('click', function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = 'actions/deny_request.php';
                form.submit();
            }
        });
    });
